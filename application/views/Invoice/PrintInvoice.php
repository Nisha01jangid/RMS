  ...
  <body>
    <?php foreach($flats as $f){ ?>
        ...
        <div class="upperdiv">
          ...
          $total_units = $f['electricity_units']+$water_units; 
          $total_unit_price = $f['electricity_rate']*$total_units; 
          $total_amount_to_pay = $f['rent']+$total_unit_price; 
          ...
          ?>
            ...
            <p style="margin-bottom:0px;"><span>किराया माह <?php echo date("F", strtotime($f['month']))." ".date("Y", strtotime($f['month'])); ?></span><span style="margin-left:150px">कमरा नं <?php echo $f['flat_no']; ?></span></p>
            ...
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">3. कुल खपत यू (1+2) * दर&emsp;₹ <?php echo $f['electricity_units']."+".$water_units." = ".$total_units."*".$f['electricity_rate']." = ".$total_unit_price; ?></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">4. कमरे का किराया&emsp;₹ <?php echo $f['rent']; ?></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">5. पिछला बिल का क्र. ......&nbsp;का&nbsp;₹ .... /- बाकी</p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">6. कुल (3+4+5) &emsp;₹ <?php echo $total_unit_price."+".$f['rent']."+..... = ".$total_amount_to_pay; ?></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">7. प्राप्त राशि (दिनांक सहित) &emsp;₹ <?php echo $f['amount_paid']."/- ".$f['payment_date']; ?></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">8. शेष राशि &emsp;₹ <?php echo $total_amount_to_pay." - ".$f['amount_paid']." = ".$outstanding_amount; ?></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">भुगतान दिनांक <?php echo date('d-m-Y',strtotime($f['due_date'])); ?> तक आवश्यक |</p>
