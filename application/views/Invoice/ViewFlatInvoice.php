    ...
    <div class="maindiv" style=" min-height:500px;
        ...
        <div class="upperdiv">
          ...
          ?>
            ...
            <p style="margin-bottom:0px;"><span>किराया माह <?php echo date("F", strtotime($month))." ".date("Y", strtotime($month)); ?></span><span style="margin-left:150px">कमरा नं <?php echo $details[0]['flat_no']; ?></span></p>
            ...
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">3. कुल खपत यू (1+2) * दर&emsp;₹ <?php $total_units."*".$details[0]['electricity_rate']." = ".$total_unit_price; ?></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">4. कमरे का किराया&emsp;₹ <?php echo $details[0]['rent']; ?></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">5. पिछला बिल का क्र. <?php if(!empty($previous_invoice)){echo $previous_invoice[0]['invoice']; ?> &nbsp;का&nbsp;₹ <?php echo $previous_outstanding[0]['outstanding_amount'] ?>/- बाकी<?php }else{ ?>&nbsp;का&nbsp;₹ &nbsp; /- बाकी<?php } ?></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">6. कुल (3+4+5) &emsp;₹ <?php echo $total_unit_price."+".$details[0]['rent']."+..... = ".$total_amount_to_pay; ?></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">7. प्राप्त राशि (दिनांक सहित) &emsp;₹ <?php echo $data['amount_paid']."/- ".$data['payment_date']; ?></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">8. शेष राशि &emsp;₹ <?php echo $total_amount_to_pay." - ".$data['amount_paid']." = ".$outstanding_details[0]['outstanding_amount']; ?></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">भुगतान दिनांक <?php echo date('d-m-Y',strtotime($details[0]['due_date'])); ?> तक आवश्यक |</p>
