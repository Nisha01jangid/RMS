    ...
    <div class="maindiv" style=" min-height:500px;
        ...
        <div class="upperdiv">
          ...
          ?>
            ...
            <p style="margin-bottom:0px;"><span>नाम श्री/श्रीमती: <b><?php echo $tenant_name." Ji"; ?></b></span><span style="margin-left:115px">कमरा नाम: <b><?php echo $data['flat_name']; ?></b></span></p>

            <!-- <p style="margin-bottom:0px;">नाम श्री/श्रीमती: <b><?php echo $tenant_name." Ji"; ?></b> </p> -->

            <p style="margin-bottom:0px;"><span>किराया माह: <b><?php echo date("F Y", strtotime($month)); ?></b></span><span style="margin-left:120px">कमरा नं: <b><?php echo $details[0]['flat_no']; ?></b></span></p>
