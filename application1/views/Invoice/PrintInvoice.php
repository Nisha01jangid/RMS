  ...
  <body>
    <?php foreach($flats as $f){ ?>
        ...
        <?php 
          ...
          $water_units = $flats[0]['water_rate']*$flats[0]['no_of_members']; 
          $total_units = $flats[0]['electricity_units']; 
          $total_unit = $flats[0]['electricity_rate']*($total_units + $water_units);
          $total_unit_price = $flats[0]['electricity_rate']*$total_units; 
          $total_others = $water_units + $total_unit_price + $flats[0]['waste'] + $flats[0]['miscellaneous'];
          // echo "<pre>";print_r($f['prev_outstanding']);die();
          $previous_outstanding=$flats[0]['prev_outstanding'];
          ...
          $total_amount_to_pay = $total_unit+$f['rent']+$f['prev_outstanding'];
          ...
          ?>
            ...
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">3. कुल खपत यू (1+2) * दर: &nbsp;<b>(<?php echo $f['electricity_units']; ?></b>+<b><?php echo $water_units; ?>) × <b><?php echo $f['electricity_rate']?></b></b>&nbsp;=
            ...
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">6. कुल (3+4+5):&emsp;<b>₹ <?php echo $total_unit."+".$f['rent']."+".$f['prev_outstanding']." = ".round($total_amount_to_pay);?> /-</b></p>
            <hr style="margin: 3px 0px;">
            <p style="margin-bottom:0px;">7. प्राप्त राशि (दिनांक सहित): <b>₹ <?php foreach ($f['paid_amount'] as $key) {
              echo $key['amount']."+";
